...
from app.api.routes.automation_diagnostics import router as automation_diagnostics_router
...
app.include_router(automation_diagnostics_router, prefix=settings.api_v1_prefix)
